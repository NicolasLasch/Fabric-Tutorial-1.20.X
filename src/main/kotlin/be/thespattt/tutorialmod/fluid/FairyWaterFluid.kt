...
abstract class FairyWaterFluid : FlowableFluid() {
    override fun getFlowing(): Fluid {
        return ModFluids.FLOWING_FAIRY_WATER
    }

    override fun getStill(): Fluid {
        return ModFluids.STILL_FAIRY_WATER
    }
    ...
    override fun getBucketItem(): Item {
        return ModFluids.FAIRY_WATER_BUCKET
    }
    ...
    override fun toBlockState(state: FluidState): BlockState {
        return ModFluids.FAIRY_WATER_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state))
    }
