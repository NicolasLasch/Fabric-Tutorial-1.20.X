package be.thespattt.tutorialmod.entity.animation
...
object ModAnimations {
    val PORCUPINE_WALK = Animation.Builder.create(2.5f).looping()
        .addBoneAnimation(
            "torso",
            Transformation(
    ...
    val PORCUPINE_IDLE = Animation.Builder.create(2f).looping()
        .addBoneAnimation(
            "torso",
            Transformation(
                Transformation.Targets.TRANSLATE,
    ...
    val PORCUPINE_ATTACK = Animation.Builder.create(2f).looping()
        .addBoneAnimation(
            "torso",
            Transformation(
                Transformation.Targets.TRANSLATE,
    ...
    val PORCUPINE_SIT = Animation.Builder.create(2f).looping()
        .addBoneAnimation(
            "porcupine",
            Transformation(
                Transformation.Targets.TRANSLATE,
