...
import be.thespattt.tutorialmod.entity.animation.ModAnimations
...
class PorcupineModel<T : PorcupineEntity?>(root: ModelPart) : SinglePartEntityModel<T>() {
    ...
    init {
        porcupine = root.getChild("porcupine")
        head = porcupine.getChild("body").getChild("torso").getChild("head")
    }
    ...
    companion object {
        val texturedModelData: TexturedModelData
            get() {
                ...
                val porcupine = modelPartData.addChild(
                    "porcupine",
                    ModelPartBuilder.create(),
                    ModelTransform.pivot(0.0f, 24.0f, 0.0f)
                )
                val body =
                    porcupine.addChild("body", ModelPartBuilder.create(), ModelTransform.pivot(0.0f, -4.0f, 0.0f))
                ...
                val cube_r1 = tail.addChild(
                    "cube_r1",
                    ModelPartBuilder.create().uv(11, 25)
                        .cuboid(-6.0f, -0.499f, -1.0f, 7.0f, 0.0f, 7.0f, Dilation(0.0f)),
                ...
                val spikes =
                    torso.addChild("spikes", ModelPartBuilder.create(), ModelTransform.pivot(0.0f, -3.0f, -3.5f))
